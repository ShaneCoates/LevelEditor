...
IMGUI_API CustomConsole* m_customConsoleInstance = nullptr;
...
CustomConsole* ImGui::GetCustomConsoleInstance()
{
	if (m_customConsoleInstance == nullptr)
	{
		m_customConsoleInstance = new CustomConsole();
	}
	return m_customConsoleInstance;
}
...
void ImGui::LogCustomConsole(char* _message)
{
	CustomConsole* console = GetCustomConsoleInstance();
	console->AddLog(_message);
}
